		...
		<div class="row">
			...
			<h4 class="section-title">Please fill in the form details below</h4>
				<h4 class="error"><?php if(isset($msg)){ echo $msg; } ?></h4>
				 ...
				 <form class="form-vertical well" action="<?php echo site_url("/application/sendcpd"); ?>" method="POST">
					  ...
					  <div class="col-xs-12">
					   <label for="emailaddress">Select Event</label>
					    ...
					    <select name="event_id" class="form-control" required>
						  <option value="AUELF2mSTVAM8feO">Financial Reporting Workshop for Cooperative Societies</option>
				    ...
				    <div class="row">
					  <div class="col-xs-6">
					   <label for="emailaddress">Start Date</label>
					    ...
					    <input type="date" name="start_date" class="form-control" placeholder="Enter Start Date" value="<?php echo set_value('start_date'); ?>" required>
					  </div>
					  <div class="col-xs-6">
					   <label for="emailaddress">End Date</label>
					    <?php echo form_error('end_date'); ?>
					    <input type="date" name="end_date" class="form-control" placeholder="Enter End Date" value="<?php echo set_value('end_date'); ?>" required>
					  </div>
					</div>
				  </div>
				  <div class="form-group">
				    <div class="row">
					  <div class="col-xs-12">
					   <label for="emailaddress">CPD Hours</label>
					    ...
					    <input type="text" name="cpd_hours" class="form-control" placeholder="Enter CPD Hours" value="<?php echo set_value('cpd_hours'); ?>" required>
					  </div>
					</div>
				  </div>
