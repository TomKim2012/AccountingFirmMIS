...
<div role="tabpanel">
	<!-- Nav tabs -->
	<br> <a href="<?php echo site_url('application/add_offence')?>"
		class="btn btn-primary">ADD OFFENCE</a> <br>
	...
	<div class="table-responsive">
		<table class="table">
			...
			<tr>
					...
					<td><a
						href="<?php echo site_url('application/edit_offence/'.$muedu->refId)?>"
						class="btn btn-info btn-xs" role="button">&nbsp;Edit </a> &nbsp; <a
						href="<?php echo site_url('application/delete_offence/'.$muedu->refId)?>"
